...
- `QR box-dual stale`, `QR box-dual robust`, `QR box-dual stale+robust`, `QR box-dual adaptive`, `QR box-dual adaptive+VR`: optional advanced variants with staleness-aware cached directions, client-robust weighting, state-adaptive weighting, and control-variate variance reduction.
